...
@section('content')
        ...
        <div class="container mt-4" style="width: 100%">
            ...
            <div class="row">
                <div class="col-3 card m-3" style="max-height: 700px; overflow-y: auto;">
                    ...
                    @if ($teacher)
                        ...
                        <form method="POST" action="{{ route('teacher.dashboard.update', $teacher->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="mb-3 mt-3">
                ...
                <div class="col-8 card m-3" style="max-height: 700px; overflow-y: auto; ">
                    ...
                    @if ($assignedSubjects->isNotEmpty())
                                    <div class="card mt-4">
                                        ...
                                        <ul class="list-group list-group-flush card-responsive-lg">
                                            @foreach ($assignedSubjects as $assignment)
                                                <li class="list-group-item">
                                                    <strong>Class:</strong>
                                                    {{ optional($assignment->schoolClass)->name ?? 'N/A' }}
